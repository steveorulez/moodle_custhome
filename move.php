...
/**
 * Move/order course functionality for custhome block.
 *
...
list($courses_sorted, $sitecourses, $coursecount) = block_custhome_get_sorted_courses();
...
block_custhome_update_myorder($neworder);
