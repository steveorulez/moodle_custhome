...
/**
 * Lang strings for custhome block
 *
...
$string['custhome:myaddinstance'] = 'Add a new course overview block to the My Moodle page';
...
$string['addnewlabel'] = 'Add new Label: ';
$string['addnewlabeltitle'] = 'Add new Label';
$string['addnewlabelalt'] = 'Add new Label';